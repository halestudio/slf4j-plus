 ...
 */
public class StatusServiceTracker implements
		ServiceTrackerCustomizer<StatusService, StatusService> {
	
	private final StatusObserver observer = new StatusObserver();

	/**
	 * @return the observer
	 */
	public StatusObserver getObserver() {
		return observer;
	}
